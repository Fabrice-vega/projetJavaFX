...
public class ScreensController  extends StackPane implements Observateur {
    ...
    private List<ControlledScreen> mesControleurs = new ArrayList<>();
    ...
    public boolean loadScreen(String name, String resource) {
        try {
            ...
            mesControleurs.add(myScreenControler);
    ...
    public void setModForControl(Modele modele) {
        if(modele != null) {
            this.modele = modele;
            for (ControlledScreen controleur : mesControleurs) {
